...
Game reference data (`data/kanji-components.min.json`, and later compound data)
is generated by dedicated scripts (e.g. `scripts/build_components.py`) from
EDRDG sources and committed. It is covered by invariant tests but is not part of
the markdown drift check.
