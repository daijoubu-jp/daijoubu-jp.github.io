...
- Game reference data (`data/kanji-components.min.json`, later compound data) is generated by
  dedicated scripts from EDRDG sources and committed. It is invariant-tested but NOT part of
  the markdown drift check (`git diff --exit-code -- data/`); do not hand-edit it either.
